...
export const discord: CoreToolDefinition[] = [
  ...
  { id: "discord.write_config", name: "write_discord_config", description: "Write Discord configuration to ~/.bot/.env.", category: "discord", executor: "client", platforms: DESKTOP, credentialRequired: "DISCORD_BOT_TOKEN", inputSchema: { type: "object", properties: { guild_id: { type: "string" }, channel_conversation: { type: "string" }, channel_updates: { type: "string" }, channel_logs: { type: "string" } }, required: ["guild_id", "channel_conversation", "channel_updates", "channel_logs"] }, annotations: { destructiveHint: true } },
