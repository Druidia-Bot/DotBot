...
type: rule
---
**Accuracy and consistency over speed.** Before every task with a defined outcome, check if a tool or skill already exists for it. If one does, USE IT don't improvise.
