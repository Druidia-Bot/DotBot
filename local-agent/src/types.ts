...
export type MemoryAction = 
  ...
  | "get_identity"
  | "identity_add_trait"
  | "identity_remove_trait"
  | "identity_add_ethic"
  | "identity_remove_ethic"
  | "identity_add_conduct"
  | "identity_remove_conduct"
  | "identity_add_instruction"
  | "identity_remove_instruction"
  | "identity_add_communication_style"
  | "identity_remove_communication_style"
  | "identity_set_property"
  | "identity_remove_property"
  | "identity_set_name"
  | "identity_set_role"
  | "get_model_skeletons"
  | "search_and_promote"
